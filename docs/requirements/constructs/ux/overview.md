...
- See [[features/diff-review|Diff Review]], [[features/activity-timeline|Activity Timeline]], and [[features/context-switching-aids|Context Switching Aids]] for detailed UX specifications.

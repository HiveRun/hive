...
## Goal
Allow operators to inspect the final prompt bundle generated for a cell template before launching it. This includes the concatenated prompt fragments and an estimated token count.
...
- Integrate with the cell creation flow (e.g., a "View prompts" modal).

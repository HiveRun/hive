...
- [x] Move Playwright runtime E2E suite runs to merge queue/main/manual (skip PR event) so primary PR CI remains lightweight while pre-merge runtime coverage is preserved.

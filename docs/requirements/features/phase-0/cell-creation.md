...
- [/] Add cell archival flow that preserves the worktree for offline replay, disables runtime surfaces, and exposes a cleanup path for deleting archived cells (HIVE-48, 2025-12-10)

...
- **Chose file-based**: Templates are defined in `hive.config.json`
- **Benefits**: 
...
- **Inline templates**: Keep templates inline within `hive.config.json` for v1 simplicity, with support for external template files in future versions.

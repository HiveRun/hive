CREATE TABLE `cell_activity_events` (
...
--> statement-breakpoint
INSERT INTO `__new_cells`("id", "name", "description", "template_id", "workspace_path", "workspace_id", "workspace_root_path", "opencode_session_id", "opencode_server_url", "opencode_server_port", "resume_agent_session_on_startup", "created_at", "status", "last_setup_error", "branch_name", "base_commit") SELECT "id", "name", "description", "template_id", "workspace_path", "workspace_id", "workspace_root_path", "opencode_session_id", "opencode_server_url", "opencode_server_port", "resume_agent_session_on_startup", "created_at", "status", "last_setup_error", "branch_name", "base_commit" FROM `cells`;--> statement-breakpoint

...
const HIVE_THEME_CONTENT = `${JSON.stringify(
  {
    ...
    theme: {
      ...
      text: { dark: "none", light: "ink" },
      textMuted: { dark: "fog", light: "steel" },
      background: { dark: "none", light: "daylight" },
      backgroundPanel: { dark: "none", light: "parchment" },
      backgroundElement: { dark: "none", light: "parchment" },
      backgroundMenu: { dark: "none", light: "parchment" },
      border: { dark: "#3A2D24", light: "#C7BDA6" },
      borderActive: { dark: "amber", light: "signal" },
      borderSubtle: { dark: "#251D18", light: "#D9D0BD" },
      ...
      diffContextBg: { dark: "none", light: "daylight" },
      ...
      markdownText: { dark: "none", light: "ink" },
      ...
      syntaxPunctuation: { dark: "none", light: "#7B7368" },
    },
  },
  null,
  2

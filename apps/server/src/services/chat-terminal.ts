...
const HIVE_THEME_CONTENT = `${JSON.stringify(
  {
    ...
    theme: {
      ...
      backgroundPanel: { dark: "soot", light: "parchment" },
      backgroundElement: { dark: "#0D1113", light: "parchment" },
      backgroundMenu: { dark: "#0D1113", light: "parchment" },
      border: { dark: "#2A2F33", light: "#C7BDA6" },
      borderActive: { dark: "amber", light: "signal" },
      borderSubtle: { dark: "#1B2023", light: "#D9D0BD" },
      ...
      diffContextBg: { dark: "#0D1113", light: "daylight" },
      ...
      syntaxPunctuation: { dark: "steel", light: "#7B7368" },
    },
  },
  null,
  2

...
function buildToolLines(): string[] {
  const lines = [
    ...
    "- `hive_restart_services` - Restart services (all or one) when something is wedged. Requires confirm=true.",
    ...
    "- Service stuck/crashed? → Call hive_restart_services (confirm=true) then re-check with hive_services",

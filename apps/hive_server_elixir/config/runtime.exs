...
#
#     PHX_SERVER=true bin/hive_server_elixir start
#
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/hive_server_elixir/hive_server_elixir.db
      """
  ...
  config :hive_server_elixir, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :hive_server_elixir, HiveServerElixir.Mailer,
